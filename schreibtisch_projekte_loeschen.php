...
$sql='SELECT DISTINCT hau_id, hau_titel FROM aufgaben ' .
    ...
    'AND (uau_status IS NULL or uau_status=0)  ';
...
if (mysql_num_rows($ergebnis) > 0)
    ...
    echo '<br><br>This Project cant be deleted as we have still the following open tasks:<br><br>';
...
$sql='UPDATE projekte SET hpr_aktiv = "0" WHERE hpr_id = "' . $hpr_id . '"';
