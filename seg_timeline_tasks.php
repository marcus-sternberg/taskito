...
$sql_task='SELECT hau_pende, hau_dauer FROM aufgaben
                WHERE hau_abschluss = 0 AND hau_kalender = 1 and hau_aktiv="1" ORDER BY hau_pende ASC';
...
$sql_task='SELECT hau_pende, hau_dauer, hau_titel FROM aufgaben 
                WHERE hau_abschluss = 0 AND hau_kalender = 1 and hau_aktiv="1" ORDER BY hau_titel';
...
$sql_task_detail='SELECT hau_pende, hau_dauer, hau_titel, hau_nonofficetime FROM aufgaben 
                WHERE hau_abschluss = 0 AND hau_kalender = 1 and hau_aktiv="1" ORDER BY hau_titel';
